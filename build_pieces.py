...
PIECES = [
    ...
    ("Посредник",    "0_GOBETWEEN",      "0_ELEPHANTPROMOTED",  2),
    ("Медный",       "0_COPPER",         "0_SIDEMOVERPROMOTED", 2),
    ("Серебряный",   "0_SILVER",         "0_VERTICALMOVERPROMOTED", 2),
    ("Золотой",      "0_GOLD",           "0_ROOKPROMOTED",      2),
    ("Свир.барс",    "0_LEOPARD",        "0_BISHOPPROMOTED",    2),
    ("Слеп.тигр",    "0_TIGER",          "0_STAG",              2),
